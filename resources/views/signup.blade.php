...
<head>
    <meta charset="UTF-8">
    <title>Sign Up - South Chirper</title>
...
<body>
                ...
                @auth
                    ...
                    <div class="flex items-center gap-3 ml-2 pl-3 border-l-2 border-black/20">
                        ...
                        <a href="/notifications" class="relative">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-black hover:scale-110 transition"
    ...
    <div class="min-h-screen bg-cover bg-center flex items-center justify-center pt-24"
        ...
        <div
            class="bg-white/90 backdrop-blur border-4 border-black rounded-3xl shadow-[6px_6px_0px_black] p-6 w-96 z-10">

            <h2 class="text-2xl font-bold text-center mb-4">Criar Conta</h2>
            ...
            <form method="POST" action="/signup" enctype="multipart/form-data">
                ...
                <input type="file" name="photo" id="photoInput"
                    class="w-full mb-3 border-2 border-black rounded-xl p-2 bg-white">


                <img id="preview"
                    class="hidden w-20 h-20 rounded-full object-cover border-2 border-black mx-auto mb-3" />

                <button class="w-full bg-blue-500 text-white border-2 border-black rounded-full py-2 font-bold">
                    Criar Conta
                </button>
            </form>
