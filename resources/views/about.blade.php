            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white border-4 border-black rounded-3xl p-6 shadow-[6px_6px_0px_black]">
                    ...
                    <p class="text-sm text-justify">
                        Tenho 18 anos e gosto de criar coisas que misturam criatividade, estética e um toque de caos
                        organizado.
                ...
                <div class="bg-white border-4 border-black rounded-3xl p-6 shadow-[6px_6px_0px_black]">
                    ...
                    <video autoplay loop muted playsinline class="w-32 h-32 mx-auto object-cover">
                ...
                <div class="bg-white border-4 border-black rounded-3xl p-6 shadow-[6px_6px_0px_black]">
                    ...
                    <p class="text-sm mb-3">
                        A escolha de South Park foi baseada no estilo louco da animação, por mais que possua muitas
                        coisas erradas, consegue fazer muitos de nós rirem.
                    </p>
                ...
                <div class="bg-white border-4 border-black rounded-3xl p-6 shadow-[6px_6px_0px_black]">
                    ...
                    <!-- eu e o kenny dançando -->
                    <div class="flex justify-between items-center mt-6">

                        <video autoplay loop muted playsinline class="w-24 h-24 object-cover">
                            <source src="{{ asset('videos/euu.mp4') }}" type="video/mp4">
                        </video>

                        <img src="{{ asset('gif/kenny.gif') }}" class="w-32 h-32 object-contain">
                ...
                <!-- card contatos -->
                <div
                    class="bg-white border-4 border-black rounded-3xl p-6 shadow-[6px_6px_0px_black] col-span-1 md:col-span-2 relative overflow-hidden text-center">

                    <img src="/images/southparklogo.png" class="absolute -top-6 -right-6 h-28 opacity-10 rotate-12">
